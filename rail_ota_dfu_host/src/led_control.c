...
uint32_t blinky_led_on_ticks, blinky_led_off_ticks;
...
void blinky_on(sl_sleeptimer_timer_handle_t *handle, void *data)
{
...
void blinky_off(sl_sleeptimer_timer_handle_t *handle, void *data)
{
  (void)handle; (void)data; // unused parameters
