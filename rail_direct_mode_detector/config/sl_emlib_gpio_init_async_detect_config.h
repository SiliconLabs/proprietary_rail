#ifndef SL_EMLIB_GPIO_INIT_ASYNC_DETECT_CONFIG_H
#define SL_EMLIB_GPIO_INIT_ASYNC_DETECT_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_ASYNC_DETECT_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_ASYNC_DETECT_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_ASYNC_DETECT_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_ASYNC_DETECT_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_ASYNC_DETECT
// $[GPIO_SL_EMLIB_GPIO_INIT_ASYNC_DETECT]
#define SL_EMLIB_GPIO_INIT_ASYNC_DETECT_PORT            gpioPortC
#define SL_EMLIB_GPIO_INIT_ASYNC_DETECT_PIN             1
// [GPIO_SL_EMLIB_GPIO_INIT_ASYNC_DETECT]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_ASYNC_DETECT_CONFIG_H
