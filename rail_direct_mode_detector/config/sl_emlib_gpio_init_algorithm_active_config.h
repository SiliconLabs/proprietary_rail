#ifndef SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE_CONFIG_H
#define SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE
// $[GPIO_SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE]
#define SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE_PORT            gpioPortC
#define SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE_PIN             2
// [GPIO_SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_ALGORITHM_ACTIVE_CONFIG_H
